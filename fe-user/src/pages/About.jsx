    ...
    <div className="px-6 py-12 font-sans"> 
      <div className="max-w-5xl mx-auto"> 
        ...
        <div className="text-center mb-12" data-aos="fade-up">
          ...
          <img
            src={quan4} // Hình ảnh đại diện cho đồ uống của Wolsom
            alt="Đồ uống Wolsom" // Mô tả hình ảnh
            className="mx-auto w-60 my-6 rounded-lg shadow-md" // cân chính về kích thước và kiểu dáng 
            data-aos="zoom-in" // Hiệu ứng phóng to khi cuốn đến 
          />
